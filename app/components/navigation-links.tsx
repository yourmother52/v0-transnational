  ...
  return (
    <nav className="ml-auto flex items-center gap-4" role="navigation" aria-label="Main navigation">
          ...
          <nav className="flex flex-col gap-4 mt-6">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="text-base font-medium hover:text-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 rounded px-3 py-2 hover:bg-gray-50"
                onClick={() => handleLinkClick(link.analyticsLabel)}
              >
                {link.label}
              </Link>
            ...
            <Button
              ...
              variant="destructive"
              size="sm"
              className="bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 flex items-center gap-2 justify-center mt-4"
      ...
      <Button
        ...
        variant="destructive"
        size="sm"
        className="hidden md:flex bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 items-center gap-2"
        aria-label="Safe exit - quickly leave this site and go to weather.com"
      >
        <LogOut className="h-4 w-4" aria-hidden="true" />
