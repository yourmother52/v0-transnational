              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <Phone className="h-6 w-6 text-brand-blue mt-1" aria-hidden="true" />
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <Mail className="h-6 w-6 text-brand-blue mt-1" aria-hidden="true" />
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <MapPin className="h-6 w-6 text-brand-blue mt-1" aria-hidden="true" />
                    <div>
