...
const jsonLd = {
  ...
  description:
    "Nonprofit organization providing accessible, safe, affirming hormone replacement therapy (HRT) services for trans and gender divergent people through licensed healthcare providers.",
  url: "https://transnationalhealth.org",
  logo: {
    "@type": "ImageObject",
  ...
  medicalSpecialty: ["Endocrinology", "Transgender Healthcare", "Hormone Replacement Therapy", "Gender Affirming Care"],
  serviceType: [
    "Hormone Replacement Therapy",
    "Transgender Healthcare",
    "Telemedicine",
